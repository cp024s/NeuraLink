`timescale 1ns / 1ps
//
// Auto-generated testbench for test2_identity
// Compares RTL cycle-by-cycle against Python model
//

module tb_test2_identity;
    parameter CLK_PERIOD = 10;
    parameter ARRAY_SIZE = 4;
    parameter DATA_WIDTH = 8;
    parameter ACC_WIDTH = 32;
    parameter NUM_CYCLES = 27;
    ...
    initial begin
        $display("");
        $display("========================================");
        $display("Testbench: test2_identity");
        ...
        expected_result_data[13] = 128'h00000004000000030000000200000001;
        input_act_valid[14] = 0;
        input_act_data[14] = 32'h00000000;
        expected_result_valid[14] = 1;
        expected_result_data[14] = 128'h00000008000000070000000600000005;
        input_act_valid[15] = 0;
        input_act_data[15] = 32'h00000000;
        expected_result_valid[15] = 1;
        expected_result_data[15] = 128'h0000000c0000000b0000000a00000009;
        input_act_valid[16] = 0;
        input_act_data[16] = 32'h00000000;
        expected_result_valid[16] = 1;
        expected_result_data[16] = 128'h000000100000000f0000000e0000000d;
        ...
        input_act_valid[25] = 0;
        input_act_data[25] = 32'h00000000;
        expected_result_valid[25] = 1;
        expected_result_data[25] = 128'h00000000000000000000000000000000;
        input_act_valid[26] = 0;
        input_act_data[26] = 32'h00000000;
        expected_result_valid[26] = 1;
        expected_result_data[26] = 128'h00000000000000000000000000000000;
